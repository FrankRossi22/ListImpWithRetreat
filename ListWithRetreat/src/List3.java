...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //p should be in-front of q and behind lastLeft
        p.next = q;
        p.previous = this.lastLeft;

        //and change it on those nodes as well
    ...
    public final T removeRightFront() {
        ...
        //remove the Node by changing the next of LastLeft and prev of p.next
        this.lastLeft.next = p.next;
        p.next.previous = this.lastLeft;
    ...
    public final void advance() {
        ...
        //changing right and left lengths
        this.leftLength++;
        this.rightLength--;
